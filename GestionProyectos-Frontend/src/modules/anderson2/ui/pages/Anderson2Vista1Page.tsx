...
export default function Anderson2Vista1Page() {
  // X: ancho SIEMPRE 100% del viewport. Y: nunca agranda más allá
  // de DESIGN_H; si viewport < DESIGN_H, achica para que entre sin
  // scroll vertical.
  ...
  return (
    <div ref={ref} className="relative h-full w-full overflow-hidden">
      <div style={{ width: '100%', height: DESIGN_H * sy, overflow: 'hidden' }}>
        <div
          style={{
            position: 'relative',
            width: DESIGN_W,
        ...
        <div className="flex h-full w-full flex-col justify-start" key="903e57b2-fa70-477d-937b-c7b31fe19506" style={{ position: 'absolute' as const, left: 1298, top: 54, width: 260, height: 38 }}><Select options={[{"value":"a","label":"a"},{"value":"b","label":"b"},{"value":"c","label":"c"}]} value={null} onChange={() => {}} /></div>
