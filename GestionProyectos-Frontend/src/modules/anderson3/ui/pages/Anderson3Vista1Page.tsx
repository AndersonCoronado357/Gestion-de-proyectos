...
export default function Anderson3Vista1Page() {
  ...
  return (
    <div ref={ref} className="relative h-full w-full overflow-hidden">
      <div style={{ position: 'relative', width: '100%', height: DESIGN_H * sy }}>
        ...
        <div className="flex h-full w-full flex-col justify-start" key="903e57b2-fa70-477d-937b-c7b31fe19506" style={{ position: 'absolute' as const, left: `81.1250%`, top: 54 * sy, width: `16.2500%`, height: 38 * sy }}><Select options={[{"value":"a","label":"a"},{"value":"b","label":"b"},{"value":"c","label":"c"}]} value={null} onChange={() => {}} /></div>
