...
export const ExternalLinkIcon = make('ExternalLinkIcon');
export const DocumentIcon = make('DocumentIcon');
export const PuzzleIcon = make('PuzzleIcon');
export const ChevronsLeftIcon = make('ChevronsLeftIcon');
export const ChevronsRightIcon = make('ChevronsRightIcon');
export const WarningTriangleIcon = make('WarningTriangleIcon');
export const HelpCircleIcon = make('HelpCircleIcon');
export const AlertCircleIcon = make('AlertCircleIcon');
export const XCircleIcon = make('XCircleIcon');
export const MenuIcon = make('MenuIcon');
export const CursorArrowRaysIcon = make('CursorArrowRaysIcon');
export const HandIcon = make('HandIcon');
export const MultiSelectIcon = make('MultiSelectIcon');
export const FrameIcon = make('FrameIcon');
export const ContainerIcon = make('ContainerIcon');
export const StarIcon = make('StarIcon');
export const ArrowLeftIcon = make('ArrowLeftIcon');
