// Caché in-memory simple para modulo-demo. Reemplazable por Redis sin cambiar
// los use-cases (ese es justo el punto de tenerlo como adapter).

class ModuloDemoCacheAdapter<V = unknown> {
...
module.exports = ModuloDemoCacheAdapter;
module.exports.default = ModuloDemoCacheAdapter;
