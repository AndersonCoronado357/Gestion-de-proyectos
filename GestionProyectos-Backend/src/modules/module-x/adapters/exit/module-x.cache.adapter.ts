// Caché in-memory simple para module-x. Reemplazable por Redis sin cambiar
// los use-cases (ese es justo el punto de tenerlo como adapter).

class ModuleXCacheAdapter<V = unknown> {
...
module.exports = ModuleXCacheAdapter;
module.exports.default = ModuleXCacheAdapter;
