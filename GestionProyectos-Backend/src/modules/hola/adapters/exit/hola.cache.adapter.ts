// Caché in-memory simple para hola. Reemplazable por Redis sin cambiar
// los use-cases (ese es justo el punto de tenerlo como adapter).

class HolaCacheAdapter<V = unknown> {
...
module.exports = HolaCacheAdapter;
module.exports.default = HolaCacheAdapter;
