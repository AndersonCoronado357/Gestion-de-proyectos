// Caché in-memory simple para login-content. Reemplazable por Redis sin cambiar
// los use-cases (ese es justo el punto de tenerlo como adapter).

class LoginContentCacheAdapter<V = unknown> {
...
module.exports = LoginContentCacheAdapter;
module.exports.default = LoginContentCacheAdapter;
