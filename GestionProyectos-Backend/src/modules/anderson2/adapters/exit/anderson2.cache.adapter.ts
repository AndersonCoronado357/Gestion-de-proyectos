// Caché in-memory simple para anderson2. Reemplazable por Redis sin cambiar
// los use-cases (ese es justo el punto de tenerlo como adapter).

class Anderson2CacheAdapter<V = unknown> {
...
module.exports = Anderson2CacheAdapter;
module.exports.default = Anderson2CacheAdapter;
