// Caché in-memory simple para anderson. Reemplazable por Redis sin cambiar
// los use-cases (ese es justo el punto de tenerlo como adapter).

class AndersonCacheAdapter<V = unknown> {
...
module.exports = AndersonCacheAdapter;
module.exports.default = AndersonCacheAdapter;
