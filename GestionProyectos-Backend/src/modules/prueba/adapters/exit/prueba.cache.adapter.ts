// Caché in-memory simple para prueba. Reemplazable por Redis sin cambiar
// los use-cases (ese es justo el punto de tenerlo como adapter).

class PruebaCacheAdapter<V = unknown> {
...
module.exports = PruebaCacheAdapter;
module.exports.default = PruebaCacheAdapter;
