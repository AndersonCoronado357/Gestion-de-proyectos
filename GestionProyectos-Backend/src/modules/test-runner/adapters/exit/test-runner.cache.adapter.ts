// Caché in-memory simple para test-runner. Reemplazable por Redis sin cambiar
// los use-cases (ese es justo el punto de tenerlo como adapter).

class TestRunnerCacheAdapter<V = unknown> {
...
module.exports = TestRunnerCacheAdapter;
module.exports.default = TestRunnerCacheAdapter;
