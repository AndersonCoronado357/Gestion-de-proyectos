// Caché in-memory simple para anderson4. Reemplazable por Redis sin cambiar
// los use-cases (ese es justo el punto de tenerlo como adapter).

class Anderson4CacheAdapter<V = unknown> {
...
module.exports = Anderson4CacheAdapter;
module.exports.default = Anderson4CacheAdapter;
