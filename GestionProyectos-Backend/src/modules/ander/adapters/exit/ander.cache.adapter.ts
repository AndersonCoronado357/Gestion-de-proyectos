// Caché in-memory simple para ander. Reemplazable por Redis sin cambiar
// los use-cases (ese es justo el punto de tenerlo como adapter).

class AnderCacheAdapter<V = unknown> {
...
module.exports = AnderCacheAdapter;
module.exports.default = AnderCacheAdapter;
