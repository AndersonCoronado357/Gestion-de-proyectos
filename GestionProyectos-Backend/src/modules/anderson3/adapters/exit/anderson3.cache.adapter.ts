// Caché in-memory simple para anderson3. Reemplazable por Redis sin cambiar
// los use-cases (ese es justo el punto de tenerlo como adapter).

class Anderson3CacheAdapter<V = unknown> {
...
module.exports = Anderson3CacheAdapter;
module.exports.default = Anderson3CacheAdapter;
