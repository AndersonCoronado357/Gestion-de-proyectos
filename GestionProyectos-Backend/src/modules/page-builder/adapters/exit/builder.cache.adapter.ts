// Caché in-memory simple para builder. Reemplazable por Redis sin cambiar
// los use-cases (ese es justo el punto de tenerlo como adapter).

class BuilderCacheAdapter<V = unknown> {
...
module.exports = BuilderCacheAdapter;
module.exports.default = BuilderCacheAdapter;
